 ...
 * 
 *  Matrix containing 5 reference/measurement vectors of size 16 for first 5 nodes.
 */
real_t y[ 80 ];
...
/** Matrix of size: 50 x 16 (row major format) */
real_t Q2[ 800 ];

/** Matrix of size: 20 x 4 (row major format) */
real_t R1[ 80 ];

/** Matrix of size: 20 x 16 (row major format) */
real_t R2[ 320 ];
